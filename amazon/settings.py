...
SECRET_KEY = 'django-insecure-@!itg4+l3!*dn4tf(7)fzw$kq4*@eplbmx=5aaei16_tb7r5+('

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1','abhayshoping.herokuapp.com']
